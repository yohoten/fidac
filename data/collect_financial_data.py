...
==========================================
模块1: 17家A股车企 三大报表标准化采集 (2016Q1—2025Q4)
...
COMPANIES = [
    ('601127','赛力斯','★主研究·AITO问界'),    ('000625','长安汽车','★主研究·合资新能源'),
    ('002594','比亚迪','纯电+插混'),           ('600104','上汽集团','智己/荣威'),
    ('601633','长城汽车','哈弗/坦克'),         ('601238','广汽集团','广汽埃安'),
    ('600418','江淮汽车','蔚来代工·尊界'),     ('600733','北汽蓝谷','极狐'),
    ('000550','江铃汽车','轻卡/皮卡'),         ('000800','一汽解放','重卡龙头'),
    ('600006','东风汽车','商用车'),            ('000951','中国重汽','重卡'),
    ('600066','宇通客车','客车龙头'),          ('000957','中通客车','客车'),
    ('600686','金龙汽车','客车'),              ('000572','海马汽车','乘用车'),
    ('601777','力帆科技','转型新能源'),
]
...
def main():
    ...
    logger.info(f'  17家A股车企 | 2016Q1—2025Q4 | 会计准则: A股统一')
    logger.info(f'  输出: {DATA_DIR}')
    logger.info(f'{"="*80}\n')

    # === 模块1: 三大报表 ===
    logger.info(f'{"="*60}')
    logger.info(f'  模块1: 17家A股车企 三大报表')
    logger.info(f'{"="*60}')
